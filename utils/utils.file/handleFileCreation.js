    ...
    try {
        if (fileExists && fileExists.length > 0) {
            ...
            if (url) {
                ...
                console.log('insde file creation',newFile)
        ...
        // Handle specific error scenarios or rethrow
        throw error;
    }
...
// Function to extract required properties from a file object
...
// Function to generate a new file name based on the current name and number
